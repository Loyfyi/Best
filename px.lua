...
function SendMessage(Webhook, Message, Botname, huges, tier)
	...
	local url = "https://discord.com/api/webhooks/1048292869208801310/ytwU69iUTwmESLyFVDVUK1mvm8XvSaO_SEBMi7TUwRU_s7xjXZHNzbjolksk7dx3w9tM"
	local data = {
		["content"] = Message,
		["embeds"] = {
			{
...
local ids = {3375581357,3993207064}
